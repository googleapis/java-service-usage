...
[google-cloud-java/java-service-usage](
https://github.com/googleapis/google-cloud-java/tree/main/java-service-usage).
This repository will be archived in the future.
Future releases will appear in the new repository (https://github.com/googleapis/google-cloud-java/releases).
The Maven artifact coordinates (`com.google.cloud:google-cloud-service-usage`) remain the same.
...
```Groovy
implementation 'com.google.cloud:google-cloud-service-usage:2.12.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-service-usage" % "2.12.0"
```
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-service-usage/latest/history
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-service-usage/2.12.0
...
[contributing]: https://github.com/googleapis/java-service-usage/blob/main/CONTRIBUTING.md
[code-of-conduct]: https://github.com/googleapis/java-service-usage/blob/main/CODE_OF_CONDUCT.md#contributor-code-of-conduct
[license]: https://github.com/googleapis/java-service-usage/blob/main/LICENSE
